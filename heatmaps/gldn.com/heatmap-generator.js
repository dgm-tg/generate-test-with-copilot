  ...
  try {
    ...
    await page.evaluate(() => {
      ...
      const addHotspot = (x, y, intensity, size) => {
        ...
        hotspot.style.boxShadow = '0 0 ' + (size/2) + 'px ' + (size/3) + 'px ' + getColorForIntensity(intensity);
        return hotspot;
      };
    ...
    const compositeHtmlPath = path.join(__dirname, 'gldn-heatmap-analysis.html');
    const htmlContent = `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <title>GLDN.com Heatmap Analysis</title>
        <style>
          ...
          .comparison .image-col { flex: 1; min-width: 300px; }
      ...
      <body>
        <h1>GLDN.com Heatmap Analysis</h1>
        
        <div class="comparison">
          <div class="image-col">
            <h2>Original Screenshot</h2>
            <div class="image-container">
              <img src="gldn-control-screenshot.png" alt="GLDN.com Original Screenshot">
            </div>
          </div>
